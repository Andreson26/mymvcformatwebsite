...
<section class="section background-white">
            <div class="s-12 m-12 l-4 center">
              ...
              <form name="contactForm" class="customform" method="post">
                <div class="s-12"> 
                  <input name="title" class="subject" placeholder="Title" title="Titlet" type="text" required>
                ...
                <div class="s-12">
                  <textarea name="description" class="required message" placeholder="Description" rows="5"></textarea>
