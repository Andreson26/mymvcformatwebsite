...
<footer>
    ...
    <script type="text/javascript" src="<?=ASSETS?>logic/js/responsee.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>logic/js/jquery.events.touch.js"></script>
    <script type="text/javascript" src="owl-carousel/owl.carousel.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>logic/js/template-scripts.js"></script> 
  </body>
</html>